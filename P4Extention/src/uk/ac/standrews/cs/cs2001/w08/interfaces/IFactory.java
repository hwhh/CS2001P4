...
public interface IFactory {
    ...
    IPriorityQueue makePriorityQueueUsingDoubleStack(int maxSize);

    IPriorityQueue makePriorityQueueUsingLinkedList(int maxSize);

    IPriorityQueue makeQueueUsingDoubleStack(int maxSize);

    IStack makeStackUsingLinkedList();
